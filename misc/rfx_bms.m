function [rfx] = rfx_bms (lme, Nsamp, do_plot, sampling, ecp, alpha0)
% Bayesian model selection for group studies
% FORMAT [rfx] = rfx_bms (lme, Nsamp, do_plot, sampling, ecp, alpha0)
% 
% INPUT:
...
%           are equal)
% .g       - g(n,k) is posterior probability subject n uses model k
% 
% REFERENCES:
%
